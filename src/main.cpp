...
#if defined(NDEBUG)
# error "Qoptercoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x0fbff2a42ca1bbb8e012a6c703a96f13d8d83ba986e282de00e650a9d56956b8");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Qoptercoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Qoptercoin Signed Message:\n";
...
{
    // Qoptercoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Qoptercoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 60 * 60 * 24; // Qoptercoin: 24h minutes
static const int64 nTargetSpacing = 5 * 60; // Qoptercoin: 300 seconds
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Qoptercoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Qoptercoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0fbff2a42ca1bbb8e012a6c703a96f13d8d83ba986e282de00e650a9d56956b8");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "NY Times, 01-21-2017: THE 45TH PRESIDENT TRUMP RENOUNCES NATIONÕS POLITICAL CLASS";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("646484710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1485017607;
        ...
        assert(block.hashMerkleRoot == uint256("0xd4302808d412f0bb288a58d48263d1b4fdc6971207b0e35145af2531c1568f94"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Qoptercoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("QoptercoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("QoptercoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static QoptercoinMiner(CWallet *pwallet)
{
    printf("QoptercoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("qoptercoin-miner");
    ...
    try { loop {
        ...
        printf("Running QoptercoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("QoptercoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&QoptercoinMiner, pwallet));
}
